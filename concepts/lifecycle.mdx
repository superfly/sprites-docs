...
og:description: "How a Sprite sleeps, wakes, and keeps your data. The model behind warm and cold states and the filesystem that survives them"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Keeping a Sprite Running" icon="layer" href="/keeping-sprites-running">
  Hold a Sprite in an active state while work finishes
</Card>
  <Card title="Sprite Maintenance" icon="wrench" href="/sprite-maintenance">
