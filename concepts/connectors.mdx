---
title: Connectors
og:description: Give Sprites access to external APIs without putting provider credentials inside the Sprite
---
...
> "Comment 'tests are green, ready to merge' on GitHub PR #42 in acme/website."<br/><br/>
>
> "Open a GitHub issue in my repo titled 'flaky test'."<br/><br/>
>
