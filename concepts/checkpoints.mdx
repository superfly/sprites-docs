---
title: Checkpoints
og:description: "Save a Sprite's filesystem at a point in time and roll back to it later. The deliberate save point that complements automatic persistence"
---
...
<CardGroup cols={2}>
  <Card title="CLI Commands" icon="terminal" href="/cli/commands#checkpoints">
  Full reference for sprite checkpoint create, list, info, delete, and restore
</Card>
  <Card title="Lifecycle and Persistence" icon="layer" href="/concepts/lifecycle">
  ...
  <Card title="Working with Sprites" icon="terminal" href="/working-with-sprites">
