...
og:description: Run Cursor Cloud Agents on your own Sprites from the Sprites dashboard
---
...
<CardGroup cols={2}>
  <Card title="Cursor: Self-Hosted Machines" icon="book-open" href="https://cursor.com/docs/cloud-agent/self-hosted">
  Cursor's reference for My Machines and self-hosted workers
</Card>
  <Card title="Services" icon="cog" href="/concepts/services">
  Supervised long-running processes inside a Sprite
</Card>
  <Card title="Keeping a Sprite running" icon="zap" href="/keeping-sprites-running">
  The Tasks API hold the worker uses while it is connected
</Card>
  <Card title="Lifecycle and Persistence" icon="layers" href="/concepts/lifecycle">
