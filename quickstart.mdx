---
title: Quickstart
og:description: Get up and running with Sprites in 5 minutes
---

<Frame>![A bespectacled bird reading a quickstart guide while a small creature sleeps in a tiny bed nearby](/images/quickstart.png)</Frame>
...
<CardGroup cols={2}>
  <Card title="Working with Sprites" icon="book-open" href="/working-with-sprites">
