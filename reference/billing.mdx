---
title: Billing
og:description: Sprites pricing and billing details
---

import PricingRates from '/snippets/PricingRates.mdx';

import {BillingCalculator} from '/snippets/BillingCalculator.jsx';
...
<CardGroup cols={2}>
  <Card title="Lifecycle" icon="layer" href="/concepts/lifecycle">
  Understanding hibernation behavior
</Card>
  <Card title="Configuration" icon="gear" href="/reference/configuration">
  Resource options and settings
</Card>
  <Card title="Checkpoints" icon="folder" href="/concepts/checkpoints">
  Checkpoint storage and management
</Card>
  <Card title="Quickstart" icon="rocket" href="/quickstart">
  Get started with Sprites
</Card>
</CardGroup>
