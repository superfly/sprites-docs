...
og:description: All configuration options for Sprites
---
...
<CardGroup cols={2}>
  ...
  <Card title="Billing" icon="file-lines" href="/reference/billing">
  Pricing details and cost estimation
</Card>
  <Card title="CLI Commands" icon="terminal" href="/cli/commands">
  Full CLI reference documentation
</Card>
  <Card title="Base Images" icon="folder" href="/reference/base-images">
