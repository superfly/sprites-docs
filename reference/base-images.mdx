---
title: Base Images
og:description: Pre-configured development environments for Sprites
---
...
<CardGroup cols={2}>
  ...
  <Card title="Networking" icon="zap" href="/concepts/networking">
  URLs, ports, and network configuration
</Card>
