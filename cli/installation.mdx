...
og:description: "Install the Sprites CLI on macOS, Linux, or Windows"
---

import CliDownloads from '/snippets/CliDownloads.mdx';

<Frame>![A round green creature connected by a cable to a laptop displaying the word Install](/images/install-cli.png)</Frame>
...
<CardGroup cols={2}>
  <Card title="Authentication" icon="gear" href="/cli/authentication">
