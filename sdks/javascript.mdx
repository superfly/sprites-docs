...
og:description: Use Sprites programmatically with the JavaScript/TypeScript SDK
---
...
Note: No external dependencies. Uses only the Node.js standard library.
...
<CardGroup cols={2}>
  <Card title="Sprites Guide" icon="book-open" href="/sprites">
  Comprehensive guide to working with Sprites
</Card>
  <Card title="Go SDK" icon="code" href="/sdks/go">
  Go SDK reference documentation
</Card>
  <Card title="Elixir SDK" icon="code" href="/sdks/elixir">
  Elixir SDK reference documentation
</Card>
  <Card title="REST API" icon="zap" href="/api">
  HTTP API reference
</Card>
