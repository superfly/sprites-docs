    ...
    >
      ...
      <div className="relative rounded-xl border border-[var(--sl-color-hairline)] bg-gradient-to-b from-[var(--sl-color-bg-nav)] to-[var(--sl-color-bg-sidebar)] overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse at 70% 50%, oklch(0.5 0.1 250 / 0.1) 0%, transparent 50%)',
          }}
        />
                ...
                <div className="flex flex-col items-center gap-1.5">
                  ...
                  <span
                    className={cn(
                      ...
                      phase === p
                        ? 'text-[var(--sl-color-accent)]'
                        : 'text-[var(--sl-color-gray-3)]/60',
                    )}
                  >
                    {p === 'active'
                      ? 'Active'
                ...
                {i < 3 && (
                  <div
                    className={cn(
                      ...
                      phases.indexOf(phase) > i
                        ? 'bg-[var(--sl-color-accent)]/50'
                        : 'bg-[var(--sl-color-hairline)]',
                    )}
                  />
                )}
              </div>
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-[var(--sl-color-gray-2)]">
                    Running on compute
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <span className="font-mono text-[var(--sl-color-accent)]">
                  &lt;1ms
                </span>
              </div>
            </div>
                ...
                <div className="absolute inset-0 overflow-hidden">
                  {dataItems.map((dataItem, i) => {
                    ...
                    return (
                      ...
                      >
                        <ItemIcon className={cn('h-3 w-3', dataItem.color)} />
                      </div>
                    );
                  })}
                </div>
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                >
                  <Moon
                    className={cn(
                      'h-5 w-5',
                      phase === 'hibernated' && 'animate-pulse',
                    )}
                  />
                </div>
                <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {dataItems.map((item, i) => (
                    <div
                      ...
                      style={{
                        transitionDelay:
                          phase === 'hibernating' ? `${i * 100}ms` : '0ms',
                      }}
                    >
                      <item.icon className={cn('h-3.5 w-3.5', item.color)} />
                      <span>{item.label}</span>
          ...
          <div className="mt-6 flex flex-col items-center gap-2">
            <div
              className={cn(
                ...
                phase === 'active' &&
                  'bg-[var(--sl-color-accent)]/10 text-[var(--sl-color-accent)]',
              ...
              {!isTransferring && (
                <span
                  className={cn(
                    ...
                    phase === 'active' &&
                      'bg-[var(--sl-color-accent)] animate-pulse',
