...
<Callout type="info">
[`fly-apps/sprites-claude-managed-agents`](https://github.com/fly-apps/sprites-claude-managed-agents) is a working reference implementation of this integration, with both worker variants (webhook and always-on poller) and the in-Sprite runner, in Python.
</Callout>
