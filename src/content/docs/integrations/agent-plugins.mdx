---
title: Agent plugins
description: Use Sprites from Codex, Cursor, Antigravity, Grok Build, DeepSeek Harness, OpenCode, Pi, Herdr, and Hermes Agent
---
...
<Callout type="warning" title="Review what Hermes uploads">
