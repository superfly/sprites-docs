---
title: Agent plugins
description: Use Sprites from Codex, Cursor, Antigravity, Grok Build, DeepSeek Harness, OpenCode, Pi, OpenClaw, and Herdr
---
...
<Callout type="warning" title="Agent authentication is separate">
