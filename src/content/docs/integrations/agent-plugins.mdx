---
title: Agent plugins
description: Use Sprites from Codex, Cursor, Antigravity, Grok Build, DeepSeek Harness, OpenCode, Pi, and Herdr
---
...
- For OAuth-based plugins, have a browser available for authorization. For Pi, [create a Sprites API token](https://sprites.dev/account) and use the storage method in its setup instructions.
