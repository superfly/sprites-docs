...
- **Self-hosted machines enabled** for the Cursor account that owns the key: open [Cloud Agents settings](https://cursor.com/dashboard/cloud-agents#self-hosted) in the Cursor dashboard and turn on **Enable Self-hosted Machines**.
...
4. Check **Computer use** if the agent should have a desktop and a browser. See [Computer use](#computer-use) for what that adds.
