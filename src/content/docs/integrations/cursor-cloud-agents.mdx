...
<img
  src="/images/integrations/cursor-cloud-agents-create.webp"
  alt="The Cursor Cloud Agents page in the Sprites dashboard, with the Create a Cursor machine form and the What happens steps"
  width="1600"
  height="1156"
  style="border-radius: 0.75rem; margin-block: 1.5rem;"
/>
...
<img
  src="/images/integrations/cursor-cloud-agents-session.webp"
  alt="A Cursor Cloud Agent session on a Sprites machine, answering a question about the Sprite it runs in"
  width="1600"
  height="1156"
  style="border-radius: 0.75rem; margin-block: 1.5rem;"
/>
