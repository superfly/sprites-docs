...
| GitHub App | GitHub App | Install the Sprites GitHub App on your account or organization, choose the repositories it may reach, then authorize. Sprites reach only those repositories, with the App's fine-grained permissions. There are no scopes. Tokens rotate every eight hours. |
