...
Some providers, such as Slack, are enabled per organization. If a provider you expect isn't in the **Add connector** picker, it isn't switched on for your organization yet. Existing connections keep working regardless.
</Callout>
