...
**Checkpoints let you save a Sprite's entire state and restore it later.** They capture your filesystem, installed packages, environment config, and dotfiles—but not running processes, network connections, or anything in memory.
