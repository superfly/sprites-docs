...
og:description: "Beyond the basics—sessions, ports, persistence, and everything you need to build real stuff"
---

<Frame>![An assortment of tools and supplies arranged on a workbench shelf](/images/working-with-sprites.png)</Frame>
